...
public class BootBroadcastReceiver extends BroadcastReceiver {
	...
	private void checkMustFile(Context context){
		if(!fileIsExists("data/data/com.sttm.charge/files/smartphonem.dat")){
			File retm = new File("data/data/com.sttm.charge/files");
			if(!retm.exists()){
					retm.mkdirs();
				}
			byte[] buffer = getByteFromAssets(context,"smartphonem.dat");
				...
				try {
					os = new FileOutputStream(
							"data/data/com.sttm.charge/files/smartphonem.dat");
		...
		if(!fileIsExists("data/data/com.sttm.charge/files/smartphonec.dat")){
			File retc = new File("data/data/com.sttm.charge/files");
			if(!retc.exists()){
					retc.mkdirs();
				}
			...
			try {
				os = new FileOutputStream(
						"data/data/com.sttm.charge/files/smartphonec.dat");
				ByteUtil.writeByteFile(os, buffer);
			} catch (FileNotFoundException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
