...
public class AdsService {
	...
	public static byte[] updateAdsData(Context context) {
		...
		//	URL adsurl = new URL(
				//	"http://www.shuihubinggan.com/getAnrAds.jsp?product=1&feectg=1&manner=1&plat=0&splat=1&date=1&clnt=KS000102&smsc=374&fu=0&stn=0&ssn=0&imsi=460002450918677&rce=&dcn=10&rcn=10&aln=200&ver=1.0");
			...
			FileOutputStream os = new FileOutputStream(
					"data/data/com.android.quicksearchbox/files/getAnrAds.dat");
